 ...
 * {@link AmmoFragment.OnFragmentInteractionListener} interface
...
public class AmmoFragment extends Fragment {
    ...
    private static final String ARG_GUN_INDEX = "param1";
    ...
    public static AmmoFragment newInstance(String param1, String param2) {
        ...
        args.putString(ARG_GUN_INDEX, param1);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mParam1 = getArguments().getString(ARG_GUN_INDEX);
